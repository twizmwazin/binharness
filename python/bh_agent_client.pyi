...
class BhAgentClient:
    ...
    def file_set_blocking(self, env_id: int, fd: int, blocking: bool) -> None: ...
    ...
    def get_metadata(self, env_id: int, key: str) -> str | None: ...
    def set_metadata(self, env_id: int, key: str, value: str) -> None: ...
